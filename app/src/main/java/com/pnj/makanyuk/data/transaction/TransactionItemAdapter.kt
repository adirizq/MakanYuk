...
class
TransactionItemAdapter(private val transactionItemList: ArrayList<TransactionItem>): RecyclerView.Adapter<TransactionItemAdapter.TransacationItemViewHolder>() {
